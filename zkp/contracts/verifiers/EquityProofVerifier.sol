...
contract EquityProofVerifier {
    
    uint32 constant n =   1024;
    uint16 constant nPublic =  5;
    uint16 constant nLagrange = 5;
    
    uint256 constant Qmx = 14354881664374488342883416637780414737461206016030499457635605878448097007980;
    uint256 constant Qmy = 12264859885165712199619359360293206743583024967322785906194284589732384687119;
    uint256 constant Qlx = 20749872016288800848060780444083977581798940210377721760576549360285541648176;
    uint256 constant Qly = 19578788498591560597504234810213586753321765982743368330134404536974499945814;
    uint256 constant Qrx = 17416602621565168605163212043296671446980478874233442360139869313996854081974;
    uint256 constant Qry = 16766911431264949834724877165671568702510784486251255231697967918720095272248;
    uint256 constant Qox = 854790294940713505075321195200500448528747352208913485857107128494629448355;
    uint256 constant Qoy = 9955429292775136732213192053787812435737299033327998926473998983146037323949;
    uint256 constant Qcx = 17275611048813003182008905936863376120121644143910678237798904968011532714685;
    uint256 constant Qcy = 9052627559964245917051594835548117364686627502071404960510080591873239883489;
    uint256 constant S1x = 21408577638472384140031319050432842278666354859404741371847758661370565875439;
    uint256 constant S1y = 9753345411507885466934874506116854459624285743130909637038332716704668185917;
    uint256 constant S2x = 8165072483401814431534709705191995954179872968296545946567271993544513933211;
    uint256 constant S2y = 13055174015463978969194742733464081718152702476349151695680591747639012375736;
    uint256 constant S3x = 12619283062758072978512160328819213039450901031475119202327742495147111109514;
    uint256 constant S3y = 8412722448556342318298759445113476976115627315255687010579011671083221997146;
    uint256 constant k1 = 2;
    uint256 constant k2 = 3;
    uint256 constant X2x1 = 21474144454396327845152351532083004075019990752466461242878777886918881998289;
    uint256 constant X2x2 = 14355079840173915662160829154768766226255618061600790110521282775474915766252;
    uint256 constant X2y1 = 15018688052320949682896340191709004207219634864455733154756573160086541513595;
    uint256 constant X2y2 = 698157478875086999197879883010055376419000863988910906910957365015884520156;
    ...
    function verifyProof(bytes memory proof, uint[] memory pubSignals) public view returns (bool) {
        assembly {
            ...
            function calculateChallanges(pProof, pMem, pPublic) {
                ...
                mstore( add(pMem, 832 ), mload( add( pPublic, 32)))
                
                mstore( add(pMem, 864 ), mload( add( pPublic, 64)))
                
                mstore( add(pMem, 896 ), mload( add( pPublic, 96)))
                
                mstore( add(pMem, 928 ), mload( add( pPublic, 128)))
                
                mstore( add(pMem, 960 ), mload( add( pPublic, 160)))
                
                mstore( add(pMem, 992 ), mload( add( pProof, pA)))
                mstore( add(pMem, 1024 ), mload( add( pProof, add(pA,32))))
                mstore( add(pMem, 1056 ), mload( add( pProof, add(pA,64))))
                mstore( add(pMem, 1088 ), mload( add( pProof, add(pA,96))))
                mstore( add(pMem, 1120 ), mload( add( pProof, add(pA,128))))
                mstore( add(pMem, 1152 ), mload( add( pProof, add(pA,160))))
                
                b := mod(keccak256(add(pMem, lastMem), 352), q) 
